...
function buildCard(card, col, cardNo) {
  ...
  const editableB = `<div style="display:flex;align-items:center;gap:4px;flex-wrap:wrap;margin-bottom:4px;">
      ...
      <div class="mini-toolbar" id="mtb-${cardIdStr}" style="margin:0;border-radius:6px;padding:3px 6px;gap:3px;">
        <button class="mini-tb-btn" style="padding:2px 6px;font-size:12px;" onmousedown="applyFormatBefore('bold');event.preventDefault();event.stopPropagation()"><b>B</b></button>
        <button class="mini-tb-btn" style="padding:2px 6px;font-size:12px;" onmousedown="miniCmd('insertOrderedList');event.preventDefault();event.stopPropagation()">1.</button>
        <button class="mini-tb-btn" style="padding:2px 6px;font-size:12px;" onmousedown="miniCmd('insertUnorderedList');event.preventDefault();event.stopPropagation()">•</button>
