...
<div id="mobile-settings-sheet" style="display:none;position:fixed;inset:0;z-index:9999;">
  ...
  <div style="position:absolute;bottom:0;left:0;right:0;background:var(--surface);border-radius:20px 20px 0 0;padding:20px 0 32px;">
    ...
    <a href="orders-dashboard.html" style="display:flex;align-items:center;gap:14px;padding:14px 20px;text-decoration:none;color:var(--text);border-bottom:1px solid var(--border);">
      <span style="font-size:20px;">📦</span>
      <span style="font-size:15px;font-weight:500;">訂單管理</span>
    </a>
